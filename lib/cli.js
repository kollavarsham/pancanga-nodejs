 ...
 *
 * Copyright (c) 2015 The Kollavarsham Team
...
var SakaDate = Kollavarsham.SakaDate;
...
var printTryOutput = function (modernDate) {
  ...
  console.log(sprintf('Saka %4s Vikrama %4s | %s %s%3s  | AD%5s %2s %2s %s',
    modernDate.calendarData.YearSaka, modernDate.calendarData.YearSaka + 135, modernDate.calendarData.masa.saka,
    modernDate.calendarData.paksa, modernDate.calendarData.tithiDay, modernDate.gregorianDate.getFullYear(),
...
var printListOutput = function (hinduDate) {
  console.log(sprintf('%4s %2s %2s %s|Saka %4s|V.S. %4s %17s %5s %2s %s',
    ...
    hinduDate.weekdayName.substr(0, 3), hinduDate.calendarData.YearSaka, hinduDate.calendarData.YearVikrama,
    hinduDate.calendarData.adhimasa + hinduDate.calendarData.masa, hinduDate.calendarData.paksa, hinduDate.calendarData.tithiDay,
    hinduDate.calendarData.naksatra));
  console.log('===============================================================================');
};
...
var printVerboseOutput = function (hinduDate, settings) {
  ...
  console.log(sprintf(' Indian date (luni-solar year and amanta month)  (*) local sunrise...%2sh %2sm\n',
    hinduDate.calendarData.sriseh, hinduDate.calendarData.srisem));
  console.log(sprintf(' year(atita):Saka %4s |Vikrama %4s |Kali %4s | ayanamsa: %2sd %2sm',
    hinduDate.calendarData.YearSaka, hinduDate.calendarData.YearVikrama, hinduDate.calendarData.YearKali, hinduDate.calendarData.ayanadeg, hinduDate.calendarData.ayanamin));
  ...
  console.log(sprintf('       %s%s', hinduDate.calendarData.adhimasa, hinduDate.calendarData.masa));
  console.log(sprintf(' %s %2s (fraction = 0.%s)', hinduDate.calendarData.paksa, hinduDate.calendarData.tithiDay,
    (1 + hinduDate.calendarData.ftithi).toString().substr(2, 3)));
  console.log(sprintf(' solar month and day: %s %s (samkranti: on %4s %2s %2s at %2sh %2sm',
    hinduDate.calendarData.sauraMasa, hinduDate.day, hinduDate.calendarData.samkrantiYear, hinduDate.calendarData.samkrantiMonth,
    hinduDate.calendarData.samkrantiDay, hinduDate.calendarData.samkrantiHour, hinduDate.calendarData.samkrantiMin));
  console.log(sprintf(' naksatra.... %s  /  karana...%s  /  yoga...%s', hinduDate.calendarData.naksatra,
...
var trySecondSetOfQuestionsHandler = function (answers) {
  ...
  var sakaDate = new SakaDate(answers.yearSaka, answers.masaNum, answers.tithiDay, answers.paksa);
  var modernDate = kollavarsham.toGregorianDateFromSaka(sakaDate);
