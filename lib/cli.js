...
var printTryOutput = function (modernDate) {
  ...
  console.log(sprintf('Saka %4s Vikrama %4s | %s %s%3s  | AD%5s %2s %2s %s',
      ...
      modernDate.globals.suklaKrsna, modernDate.globals.tithiDay, modernDate.gregorianDate.getFullYear(),
...
var printVerboseOutput = function (hinduDate, settings) {
  ...
  console.log('');
  console.log(chalk.red('                 *** TODO: Port the sub named \'write_nirayana_longitude\' ***'));
  console.log('');
  console.log(sprintf('-------------------------------------------------------------------------------'));
